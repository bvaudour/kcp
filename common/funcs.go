...
func Tr(msg string, vars ...any) string {
...
func PrintError(e any) {
	format.FormatOf("l_red").Fprintln(os.Stderr, e)
}

// PrintWarning print a yellow message in the stderr.
func PrintWarning(e any) {
	format.FormatOf("l_yellow").Fprintln(os.Stderr, e)
}
